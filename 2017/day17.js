...
function followNodeInCircularLinkedList (part, inputStr, DEBUG = false) {
  ...
  if (part === 1) {                                                                           // PART 1: ACTUALLY RUN SIMULATION
    ...
    // IN THE END WE ONLY NEED TO RETURN THE VALUE OF THE NODE THAT COMES AFTER NODE ZERO. SO INSTEAD OF ACTUALLY SIMULATING THE
    // CIRCULAR LINKED LIST, WE CAN *PRETEND* WE ARE DOING IT, AND INSTEAD ALL WE NEED TO ACTUALLY DO IS CALCULATE THE INDEX POSITION
