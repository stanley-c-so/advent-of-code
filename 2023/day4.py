...
def find_matches_between_datasets(part, input_str, DEBUG = False):
  ...
  if part == 1:
    ...
    for card_num in card_matches:
      if card_matches[card_num]:
        points += 2 ** (card_matches[card_num] - 1)
    ...
    for card_num in card_matches:
      ...
      if matches:
        for i in range(matches):
          card_count[card_num + (i + 1)] += card_count[card_num]
...
test_input = None
test_expected = None
func = find_matches_between_datasets
