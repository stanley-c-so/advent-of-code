...
def count_ways_to_divide_data_into_segments_with_dp(part, input_str, DEBUG = False):
...
test_input = None
test_expected = None
func = count_ways_to_divide_data_into_segments_with_dp
